...
def renderpackinglistcard():
    ...
    battery_total = sum(b.quantity or 0 for b in batteries)
    ...
    return dict(model=model, batteries=batteries, battery_total=battery_total, hardware=hardware, tools=tools, support_items=support_items, propellers=propellers, rigs=rigs)
